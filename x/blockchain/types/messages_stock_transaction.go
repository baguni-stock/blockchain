...
func NewMsgCreateStockTransaction(creator string, code string, count string) *MsgCreateStockTransaction {
...
func NewMsgDeleteStockTransaction(creator string, code string, count string) *MsgDeleteStockTransaction {
