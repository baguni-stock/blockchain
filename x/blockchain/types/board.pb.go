...
func (*Board) Descriptor() ([]byte, []int) {
	return fileDescriptor_4ab8909cc30d4506, []int{0}
}
...
func init() {
	proto.RegisterType((*Board)(nil), "chainstockproject.blockchain.blockchain.Board")
}

func init() { proto.RegisterFile("blockchain/board.proto", fileDescriptor_4ab8909cc30d4506) }

var fileDescriptor_4ab8909cc30d4506 = []byte{
	// 227 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4b, 0xca, 0xc9, 0x4f,
	0xce, 0x4e, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x4f, 0xca, 0x4f, 0x2c, 0x4a, 0xd1, 0x2b, 0x28, 0xca,
	0x2f, 0xc9, 0x17, 0x52, 0x07, 0x0b, 0x15, 0x97, 0xe4, 0x27, 0x67, 0x17, 0x14, 0xe5, 0x67, 0xa5,
	0x26, 0x97, 0xe8, 0x21, 0x54, 0x22, 0x31, 0xa5, 0x44, 0xd2, 0xf3, 0xd3, 0xf3, 0xc1, 0x7a, 0xf4,
	0x41, 0x2c, 0x88, 0x76, 0xa5, 0x7c, 0x2e, 0x56, 0x27, 0x90, 0x69, 0x42, 0x12, 0x5c, 0xec, 0xc9,
	...
	0xc5, 0x92, 0x94, 0x9f, 0x52, 0x29, 0xc1, 0x02, 0x16, 0x04, 0xb3, 0x41, 0x62, 0x29, 0x89, 0x25,
	0xa9, 0x12, 0xac, 0x10, 0x31, 0x10, 0xdb, 0x29, 0xf4, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4,
	0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1, 0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f,
	0xe5, 0x18, 0xa2, 0xac, 0xd3, 0x33, 0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x11,
	0x9e, 0xd2, 0x85, 0xfa, 0x4a, 0x1f, 0xc9, 0xff, 0x15, 0xc8, 0x9c, 0x92, 0xca, 0x82, 0xd4, 0xe2,
	0x24, 0x36, 0xb0, 0x77, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x77, 0x45, 0xe4, 0x70, 0x27,
	0x01, 0x00, 0x00,
}
...
func (m *Board) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Date) > 0 {
		i -= len(m.Date)
		copy(dAtA[i:], m.Date)
		i = encodeVarintBoard(dAtA, i, uint64(len(m.Date)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Body) > 0 {
		i -= len(m.Body)
		copy(dAtA[i:], m.Body)
		i = encodeVarintBoard(dAtA, i, uint64(len(m.Body)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintBoard(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
