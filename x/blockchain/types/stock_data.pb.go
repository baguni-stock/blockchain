...
func (m *StockData) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
var fileDescriptor_06d7c999d46fe03e = []byte{
	...
	0xc5, 0x96, 0x98, 0x9b, 0x5f, 0x9a, 0x57, 0x22, 0xc1, 0x04, 0x16, 0x85, 0xf2, 0x94, 0x9a, 0x19,
	0xb9, 0x38, 0xc1, 0xba, 0x5c, 0x12, 0x4b, 0x12, 0x85, 0x24, 0xb8, 0xd8, 0x93, 0x8b, 0x52, 0x13,
	0x4b, 0xf2, 0x8b, 0xa0, 0x9a, 0x61, 0x5c, 0x21, 0x11, 0x2e, 0xd6, 0xcc, 0xbc, 0x94, 0xd4, 0x0a,
	0xa8, 0x76, 0x08, 0x47, 0xc8, 0x8d, 0x8b, 0x0d, 0xec, 0xdc, 0x62, 0x09, 0x66, 0x05, 0x66, 0x0d,
	0x6e, 0x23, 0x3d, 0x3d, 0x22, 0xbd, 0xa0, 0x07, 0xb6, 0x33, 0x08, 0xaa, 0xdb, 0x29, 0xf4, 0xc4,
	...
	0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x11, 0x66, 0xeb, 0x42, 0x0d, 0xd7, 0x47, 0x0a, 0xce, 0x0a, 0x64,
	0x4e, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x38, 0x60, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff,
	0xff, 0xb2, 0x85, 0x5a, 0xc2, 0x76, 0x01, 0x00, 0x00,
}
...
func (m *StockData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintStockData(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
