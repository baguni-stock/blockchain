...
var fileDescriptor_06d7c999d46fe03e = []byte{
	...
	0xce, 0x4f, 0x49, 0x95, 0x60, 0x52, 0x60, 0xd4, 0x60, 0x0d, 0x02, 0xb3, 0x85, 0xc4, 0xb8, 0xd8,
	0x12, 0x73, 0xf3, 0x4b, 0xf3, 0x4a, 0x24, 0x98, 0xc1, 0xa2, 0x50, 0x9e, 0x52, 0x23, 0x23, 0x17,
	0x27, 0xd8, 0x24, 0x97, 0xc4, 0x92, 0x44, 0x21, 0x09, 0x2e, 0xf6, 0xe4, 0xa2, 0xd4, 0xc4, 0x92,
	0xfc, 0x22, 0xa8, 0x81, 0x30, 0x2e, 0xc8, 0xcc, 0x94, 0xc4, 0x12, 0x88, 0x99, 0x9c, 0x41, 0x60,
	0xb6, 0x90, 0x1b, 0x17, 0x1b, 0xd8, 0x03, 0xc5, 0x12, 0xcc, 0x0a, 0xcc, 0x1a, 0xdc, 0x46, 0x7a,
	0x7a, 0x44, 0x7a, 0x4a, 0x0f, 0x6c, 0x63, 0x10, 0x54, 0xb7, 0x53, 0xe8, 0x89, 0x47, 0x72, 0x8c,
	...
	0xe7, 0xea, 0x23, 0xcc, 0xd6, 0x85, 0x1a, 0xae, 0x8f, 0x14, 0xc0, 0x15, 0xc8, 0x1c, 0x50, 0x28,
	0x14, 0x27, 0xb1, 0x81, 0x83, 0xca, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xe6, 0x04, 0xec, 0x37,
	0x88, 0x01, 0x00, 0x00,
}
...
func (m *Stock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Code != 0 {
		i = encodeVarintStockData(dAtA, i, uint64(m.Code))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Type) > 0 {
...
func (m *Stock) Size() (n int) {
	...
	if m.Code != 0 {
		n += 1 + sovStockData(uint64(m.Code))
	}
	if m.Amount != 0 {
