...
func (m *HoldingStock) GetCount() string {
	if m != nil {
		return m.Count
	}
	return ""
...
func (m *HoldingStock) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
var fileDescriptor_5c7f749cf77905bb = []byte{
	...
	,
	...
	0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x84, 0x4d, 0xba, 0x50, 0xab, 0xf4, 0x91,
	0x42, 0xbe, 0x02, 0x99, 0x53, 0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0x0e, 0x3c, 0x63, 0x40,
	0x00, 0x00, 0x00, 0xff, 0xff, 0x33, 0x17, 0xe9, 0xaf, 0xa1, 0x01, 0x00, 0x00,
}
...
func (m *HoldingStock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Amount) > 0 {
		...
		i = encodeVarintStockTransaction(dAtA, i, uint64(len(m.Amount)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Count) > 0 {
		i -= len(m.Count)
		copy(dAtA[i:], m.Count)
		i = encodeVarintStockTransaction(dAtA, i, uint64(len(m.Count)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Code) > 0 {
